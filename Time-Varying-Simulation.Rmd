...
```{r echo = FALSE}
knitr::include_graphics(stringr::str_c(rprojroot::find_rstudio_root_file(),"/plots/dist\ from\ single\ set.pdf"))
knitr::include_graphics(stringr::str_c(rprojroot::find_rstudio_root_file(),"/plots/cdf_plot.pdf"))
