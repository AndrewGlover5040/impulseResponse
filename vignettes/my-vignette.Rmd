...
Sometimes, the model works in some situations, but misses in others. For instance:
...
The time-varying model is able to track changes in the paramters. It can be accessed with the function
`RLS_predicted_performance` for instance:
